...
**11.2 Booking modification.** This RFC defines creation and cancellation of bookings but not modification (date changes, guest count changes). A modification endpoint is deferred to a future SEP.
